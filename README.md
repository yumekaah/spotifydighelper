...
- **プレイリストでボタンが二重表示**: 一部のプレイリストページで、各トラックにボタン行が2段重ねで表示される場合があります。
  ...
  ![二重表示](screenshots/スクリーンショット%202026-06-23%20035720.png)

- **アルバムカードへの誤注入 / フッター重複**: アーティストページのアルバム一覧グリッドやページ下部のフッターにボタンが表示される場合があります（トラック行と誤認識）。

  ![誤注入](screenshots/スクリーンショット%202026-06-23%20035657.png)
