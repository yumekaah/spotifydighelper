...
![スクリーンショット](screenshots/スクリーンショット%202026-06-23%20034817.png)
...
- **プレイリストでボタンが二重表示**: 一部のプレイリストページで、各トラックにボタン行が2段重ねで表示される場合があります。
- **アルバムカードへの誤注入**: アーティストページのアルバム一覧グリッド内にボタンが表示される場合があります（トラック行と誤認識）。
- **著作権表示・日付との重なり**: アルバムページ下部の著作権表示やリリース日テキストとボタンが重なる場合があります。
- **アーティストページでの表示崩れ**: ディスコグラフィーセクションや「もっと見る」ボタン周辺でUIが重なる場合があります。
...
本拡張機能は非公式のツールであり、Sxxxxfy AB および各ストアとは一切関係ありません。

本ソフトウェアの使用によって生じたいかなる損害・不利益（アカウント停止、サービス停止、その他あらゆる問題を含む）についても、開発者は一切の責任を負いません。自己責任でご使用ください。

This is an unofficial tool and is not affiliated with or endorsed by Sxxxxfy AB or any store service. The developer takes no responsibility for any consequences arising from the use of this software.
